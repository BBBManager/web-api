...
return array(
    ...
    'Log description new record' => 'Descrição de Logs - Novo',
    'Log descroption edit record' => 'Descrição de Logs - Edição',
    'Access log removal' => 'Logs de acesso - Exclusão',
    'Access log details' => 'Logs de acesso - Detalhes',
    'Access logs list' => 'Visualização de logs do sistema',
    'Access log new record' => 'Logs de acesso - Novo',
    'Access log edit record' => 'Logs de acesso - Edição',
    'Access profile delete' => 'Perfis de acesso - Exclusão',
    'Access profile details' => 'Perfis de acesso - Detalhes',
    'Access profiles list' => 'Obtenção dos perfis de acesso',
    'Access profile new record' => 'Perfis de acesso - Novo',
    'Access profile edit record' => 'Perfis de acesso - Edição',
    'Error screen' => 'Tela de erro',
    'Group removal' => 'Exclusão de grupo',
    'Group details' => 'Visualização de grupo',
    'Groups list' => 'Listagem de grupos',
    'Group new record' => 'Criação de grupo',
    'Group edit record' => 'Atualização de grupo',
    'System home' => 'Tela inicial do sistema',
    'Invite template removal' => 'Exclusão de modelo de convite',
    'Invite template details' => 'Visualização de modelo de convite',
    'Invite templates list' => 'Listagem de modelos de convite',
    'Invite template new record' => 'Criação de modelo de convite',
    'Invite template edit record' => 'Atualização de modelo de convite',
    'Login' => 'Efetuou login',
    'Maintenance mode' => 'Modo de manutenção',
    'Room join event' => 'Entrada em sala',
    'My rooms list' => 'Listagem das minhas salas',
    'Tag removal' => 'Exclusão de tag',
    'Tag detailhs' => 'Visualização de tag',
    'Tags list' => 'Listagem de tags',
    'Tag new record' => 'Criação de tag',
    'Tag edit record' => 'Atualização de tag',
    'Meeting room events list' => 'Lista de tipos de eventos da sala',
    'Room details by URL' => 'Busca de sala por url',
    'Rooms list by URL' => 'Consulta de salas por url',
    'Room invite details' => 'Visualização de convite',
    'Room invite send' => 'Envio de convite',
    'Room invite edit record' => 'Convite - Edição',
    'Meeting room history' => 'Histórico da sala',
    'Meeting room removal' => 'Exclusão de sala',
    'Meeting room details' => 'Visualização de sala',
    'Meeting rooms list' => 'Listagem de salas',
    'Meeting room new record' => 'Criação de sala',
    'Meeting room edit record' => 'Atualização de sala',
    'Room audience' => 'Relatório de audiência',
    'ACL retrieval' => 'Obtenção de regras de ACL',
    'Speed profile removal' => 'Exclusão de perfil de velocidade',
    'Speed profile details' => 'Visualização de perfil de velocidade',
    'Speed profiles list' => 'Listagem de perfil de velocidade',
    'Speed profile new record' => 'Criação de perfil de velocidade',
    'Speed profile edit record' => 'Atualização de perfil de velocidade',
    'User removal' => 'Exclusão de usuário',
    'User details' => 'Visualização de usuário',
    'Users list' => 'Listagem de usuários',
    'User new record' => 'Criação de usuário',
    'User edit record' => 'Atualização de usuário',
    'User password generation' => 'Geração de nova senha',
