...
class Api_MyRoomsController extends Zend_Rest_Controller {
	...
	try {
	    ...
	    } elseif ($rMyRoomData['status'] == BBBManager_Config_Defines::$ROOM_WAITING) {
		...
		$userRoleInMeetingRoom = $bbbRoleMapper[$rMyRoomData['user_profile_in_meeting']];
		...
		$rBbbApiRequest = array(
		    ...
		    'callbackURL' => $callbackUrl,
                    'meetingLockOnStart' => $rMyRoomData['meeting_lock_on_start'],
                    'meetingMuteOnStart' => $rMyRoomData['meeting_mute_on_start'],
                    'lockAllowModeratorLocking' => $rMyRoomData['lock_allow_moderator_locking'],
