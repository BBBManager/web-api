...
class Api_RoomsLogController extends Zend_Rest_Controller {
	...
	try {
	    ...
	    $this->view->response = array('success' => '1', 'row' => $row->toArray(), 'msg' => $this->_helper->translate('Log retrieved successfully.'));
	} catch (Exception $e) {
	    $this->view->response = array('success' => '0', 'msg' => $e->getMessage());
	}
    }
	...
	try {
	    ...
	    $this->filters['meeting_room_id'] = array('column' => 'meeting_room_log.meeting_room_id', 'label' => $this->_helper->translate('Meeting Room'), 'type' => 'integer');
	    $this->filters['user'] = array('column' => 'meeting_room_log.user_id', 'label' => $this->_helper->translate('User'), 'type' => 'integer');
	    $this->filters['meeting_room_action_id'] = array('column' => 'meeting_room_log.meeting_room_action_id', 'label' => $this->_helper->translate('Action'), 'type' => 'integer');
	    $this->filters['create_date'] = array('column' => 'meeting_room_log.date_start', 'label' => $this->_helper->translate('Date Start'), 'type' => 'datetime');
	    $this->filters['create_date2'] = array('column' => 'meeting_room_log.date_start', 'label' => $this->_helper->translate('Date Start'), 'type' => 'datetime');
