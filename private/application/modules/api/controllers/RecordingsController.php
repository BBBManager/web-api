...
class Api_RecordingsController extends Zend_Rest_Controller{
    ...
    public function getAction() {
        try {
            ...
            if($rowModel == null) throw new Exception(sprintf($this->_helper->translate('Record %s not found.'), $this->_id));
    ...
    public function putAction() {
        ...
        try {
            ...
            if($rowModel == null) throw new Exception($this->_helper->translate(sprintf('Recording %s not found.', $this->_id)));
