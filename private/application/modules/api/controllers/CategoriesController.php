...
class Api_CategoriesController extends Zend_Rest_Controller {
    ...
    public function deleteAction() {
        try {
            if (strpos($this->_id, ',') == -1) {
                ...
                if ($rowModel == null)
                    throw new Exception(sprintf($this->_helper->translate('Category %s not found.'), $this->_id));
    ...
    public function putAction() {
        ...
        try {
            ...
            $rowModel = $this->model->find($this->_id)->current();
            if ($rowModel == null)
                throw new Exception($this->_helper->translate(sprintf('Category %s not found.', $this->_id)));
