...
class IMDT_Service_Auth_Adapter_Ldap {
    ...
    public function authenticate($username, $password, $moodle = false) {
        ...
        if ($authResult->isValid()) {
            ...
            $ldapBoundUser = preg_replace(array('/CN=/', '/cn=/'), '', $userDn);
            ...
            /* if(Zend_Controller_Front::getInstance()->getRequest()->getHeader('clientIpAddress') == '177.19.174.17'){
              echo '<pre>';var_dump($groupNameXHierarchy);die;
              } */
