    ...
    public static function parseThisFilters(&$select, $arrFilters) {
        ...
        foreach($arrFilters as $paramName=>$curr) {
            ...
            if($curr['type'] == 'text') {
                ...
                if(strlen($strDatetime) != 19) continue;
                ...
                if($condition == 'e') {
                    ...
                    if(strlen($strDatetime2) == 0) continue;
    ...
    public static function parseThisQueries(&$select, $arrFilters) {
        ...
        if(count($query) > 0) {
            foreach($query as $curr) {
                ...
                elseif(!in_array($condition,array('empty','nempty')) && is_scalar($value) && (strlen(trim($value)) == 0)) continue;
