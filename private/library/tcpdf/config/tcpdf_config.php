 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', APPLICATION_PATH . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'httpdocs' . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR . 'pdf-export');

/**
 * Deafult image logo used be the default Header() method.
 * Please set here your own logo or an empty string to disable it.
 */
define ('PDF_HEADER_LOGO', DIRECTORY_SEPARATOR . 'img' . DIRECTORY_SEPARATOR . 'logo.png');
 ...
 */
define ('K_PATH_CACHE', APPLICATION_PATH . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . 'httpdocs' . DIRECTORY_SEPARATOR . 'cache');
